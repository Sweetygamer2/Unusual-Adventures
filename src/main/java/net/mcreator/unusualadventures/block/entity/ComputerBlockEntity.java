...
public class ComputerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ComputerBlockEntity(BlockPos position, BlockState state) {
		super(UnusualAdventuresModBlockEntities.COMPUTER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ComputerStorageMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
