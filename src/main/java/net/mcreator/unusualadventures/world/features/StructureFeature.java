package net.mcreator.unusualadventures.world.features;
...
import net.mcreator.unusualadventures.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, UnusualAdventuresMod.MODID);
